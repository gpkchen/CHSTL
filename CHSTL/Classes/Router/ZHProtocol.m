...
- (void)analysisOutUrl:(NSString *)urlStr{
    ...
    _head = nil;
    _params = nil;
    _head = [ZHRouter router].protocolHead;
    
    if(urlStr.length > 7){
        NSString *targetparamStr = [[urlStr substringFromIndex:7] tripleDES:kCCDecrypt key:[ZHRouter router].protocolEncodeKey];
        if(targetparamStr){
