...
//协议对象操作类型
typedef NS_ENUM(int , ZHProtocolActionType) {
    ZHProtocolActionTypeUrl = 1,//操作平台协议url
    ZHProtocolActionTypeVC = 1,//操作控制器跳转
};

/**跳转协议*/
@interface ZHProtocol : NSObject

/**协议对象操作类型*/
@property (nonatomic , assign) ZHProtocolActionType actionType;
/**跳转方式：是否PUSH*/
