...
#import "ZHScrollLabel.h"
#import "UIView+Extension.h"
#import "ZHMacro.h"

static const CGFloat kLabelExtraContentPadding = 10.0;

@interface ZHScrollLabel ()<UIGestureRecognizerDelegate>
...
@property (nonatomic , copy) ZHScrollLabelAction action;

@property (nonatomic , strong) NSTimer *timer;

@end

@implementation ZHScrollLabel
